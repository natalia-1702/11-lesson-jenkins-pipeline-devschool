   ...
   // stage('Make docker image') {
    ...
    stage('Run docker on prod-VM') {
      ...
      steps {
        ...
        sh 'ssh -i /root/.ssh/id_rsa root@10.128.0.17  "docker login -u 17021993 -p 17021993Nv"'
        sh 'ssh -i /root/.ssh/id_rsa root@10.128.0.17 "docker pull 17021993/mywebapp:1.0"'
        //sh 'docker login -u 17021993 -p 17021993Nv'
